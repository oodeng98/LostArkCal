...
def find_min_set(necklace, earring1, earring2, ring1, ring2, target, ab_stone, book_price):
    ...
    for i in target:
        if i in ab_stone:
            ...
            default[i] = 0
    necklace = [(('일격필살', 3), ('원한', 5), 1000000),
                (('일격필살', 5), ('원한', 3), 70000),
                (('일격필살', 3), ('원한', 4), 70000),
                (('일격필살', 4), ('원한', 3), 1000000),
                (('일격필살', 3), ('원한', 3), 70000),
                (('일격필살', 3), ('예리한 둔기', 5), 1000000),
                (('일격필살', 5), ('예리한 둔기', 3), 1000000),
                (('일격필살', 3), ('예리한 둔기', 4), 1000000),
                (('일격필살', 4), ('예리한 둔기', 3), 1000000),
                (('일격필살', 3), ('예리한 둔기', 3), 30000),
                (('일격필살', 3), ('기습의 대가', 5), 1000000),
                (('일격필살', 5), ('기습의 대가', 3), 1000000),
                (('일격필살', 3), ('기습의 대가', 4), 1000000),
                (('일격필살', 4), ('기습의 대가', 3), 1000000),
                (('일격필살', 3), ('기습의 대가', 3), 1000000),
                (('일격필살', 3), ('정기 흡수', 5), 1000000),
                (('일격필살', 5), ('정기 흡수', 3), 1000000),
                (('일격필살', 3), ('정기 흡수', 4), 60000),
                (('일격필살', 4), ('정기 흡수', 3), 75000),
                (('일격필살', 3), ('정기 흡수', 3), 35000),
                (('원한', 3), ('예리한 둔기', 5), 58000),
                (('원한', 5), ('예리한 둔기', 3), 20000),
                (('원한', 3), ('예리한 둔기', 4), 25000),
                (('원한', 4), ('예리한 둔기', 3), 15000),
                ...
                (('원한', 4), ('정기 흡수', 3), 5000),
                (('원한', 3), ('정기 흡수', 3), 3000),
                (('예리한 둔기', 3), ('기습의 대가', 5), 25000),
                (('예리한 둔기', 5), ('기습의 대가', 3), 20000),
                (('예리한 둔기', 3), ('기습의 대가', 4), 5000),
                (('예리한 둔기', 4), ('기습의 대가', 3), 5000),
                (('예리한 둔기', 3), ('기습의 대가', 3), 2000),
                (('예리한 둔기', 3), ('정기 흡수', 5), 29000),
                (('예리한 둔기', 5), ('정기 흡수', 3), 32000),
                (('예리한 둔기', 3), ('정기 흡수', 4), 15000),
                (('예리한 둔기', 4), ('정기 흡수', 3), 8000),
                (('예리한 둔기', 3), ('정기 흡수', 3), 8000),
                (('기습의 대가', 3), ('정기 흡수', 5), 20000),
                (('기습의 대가', 5), ('정기 흡수', 3), 25000),
                (('기습의 대가', 3), ('정기 흡수', 4), 2000),
                (('기습의 대가', 4), ('정기 흡수', 3), 10500),
                (('기습의 대가', 3), ('정기 흡수', 3), 100)]
    earring1 = [(('일격필살', 3), ('원한', 5), 1000000),
            (('일격필살', 5), ('원한', 3), 50000),
            (('일격필살', 3), ('원한', 4), 20000),
            (('일격필살', 4), ('원한', 3), 50000),
            (('일격필살', 3), ('원한', 3), 15000),
            (('일격필살', 3), ('예리한 둔기', 5), 80000),
            (('일격필살', 5), ('예리한 둔기', 3), 11111),
            (('일격필살', 3), ('예리한 둔기', 4), 25000),
            (('일격필살', 4), ('예리한 둔기', 3), 11111),
            (('일격필살', 3), ('예리한 둔기', 3), 11111),
            (('일격필살', 3), ('기습의 대가', 5), 1000000),
            (('일격필살', 5), ('기습의 대가', 3), 20000),
            (('일격필살', 3), ('기습의 대가', 4), 13000),
            (('일격필살', 4), ('기습의 대가', 3), 7000),
            (('일격필살', 3), ('기습의 대가', 3), 7000),
            (('일격필살', 3), ('정기 흡수', 5), 1000000),
            (('일격필살', 5), ('정기 흡수', 3), 15000),
            (('일격필살', 3), ('정기 흡수', 4), 25000),
            (('일격필살', 4), ('정기 흡수', 3), 8000),
            (('일격필살', 3), ('정기 흡수', 3), 5000),
            (('원한', 3), ('예리한 둔기', 5), 25000),
            (('원한', 5), ('예리한 둔기', 3), 19000),
            ...
            (('원한', 4), ('정기 흡수', 3), 1),
            (('원한', 3), ('정기 흡수', 3), 1),
            (('예리한 둔기', 3), ('기습의 대가', 5), 500),
            (('예리한 둔기', 5), ('기습의 대가', 3), 100),
            (('예리한 둔기', 3), ('기습의 대가', 4), 1),
            (('예리한 둔기', 4), ('기습의 대가', 3), 50),
            (('예리한 둔기', 3), ('기습의 대가', 3), 1),
            (('예리한 둔기', 3), ('정기 흡수', 5), 3645),
            (('예리한 둔기', 5), ('정기 흡수', 3), 3000),
            (('예리한 둔기', 3), ('정기 흡수', 4), 10),
            (('예리한 둔기', 4), ('정기 흡수', 3), 1),
            (('예리한 둔기', 3), ('정기 흡수', 3), 1),
            (('기습의 대가', 3), ('정기 흡수', 5), 1),
    ...
    earring2 = [
        ...
        (('일격필살', 4), ('원한', 3), 55000),
        (('일격필살', 3), ('원한', 3), 25000),
        (('일격필살', 3), ('예리한 둔기', 5), 130000),
        (('일격필살', 5), ('예리한 둔기', 3), 1000000),
        (('일격필살', 3), ('예리한 둔기', 4), 35555),
        (('일격필살', 4), ('예리한 둔기', 3), 15000),
        (('일격필살', 3), ('예리한 둔기', 3), 15000),
        (('일격필살', 3), ('기습의 대가', 5), 105000),
        (('일격필살', 5), ('기습의 대가', 3), 1000000),
        (('일격필살', 3), ('기습의 대가', 4), 105000),
        (('일격필살', 4), ('기습의 대가', 3), 20000),
        (('일격필살', 3), ('기습의 대가', 3), 19999),
        (('일격필살', 3), ('정기 흡수', 5), 1000000),
        (('일격필살', 5), ('정기 흡수', 3), 50000),
        (('일격필살', 3), ('정기 흡수', 4), 1000000),
        (('일격필살', 4), ('정기 흡수', 3), 20000),
        (('일격필살', 3), ('정기 흡수', 3), 500),
        (('원한', 3), ('예리한 둔기', 5), 28000),
        (('원한', 5), ('예리한 둔기', 3), 15000),
        (('원한', 3), ('예리한 둔기', 4), 5000),
        ...
        (('원한', 4), ('정기 흡수', 3), 3000),
        (('원한', 3), ('정기 흡수', 3), 1000),
        (('예리한 둔기', 3), ('기습의 대가', 5), 3000),
        (('예리한 둔기', 5), ('기습의 대가', 3), 100),
        (('예리한 둔기', 3), ('기습의 대가', 4), 1),
        (('예리한 둔기', 4), ('기습의 대가', 3), 100),
        (('예리한 둔기', 3), ('기습의 대가', 3), 1),
        (('예리한 둔기', 3), ('정기 흡수', 5), 7000),
        (('예리한 둔기', 5), ('정기 흡수', 3), 5000),
        (('예리한 둔기', 3), ('정기 흡수', 4), 1),
        (('예리한 둔기', 4), ('정기 흡수', 3), 1),
        (('예리한 둔기', 3), ('정기 흡수', 3), 1),
        (('기습의 대가', 3), ('정기 흡수', 5), 582),
        (('기습의 대가', 5), ('정기 흡수', 3), 2000),
        (('기습의 대가', 3), ('정기 흡수', 4), 300),
        (('기습의 대가', 4), ('정기 흡수', 3), 1),
        (('기습의 대가', 3), ('정기 흡수', 3), 1),
    ]
    ring1 = [
        ...
        (('일격필살', 4), ('원한', 3), 30000),
        (('일격필살', 3), ('원한', 3), 30000),
        (('일격필살', 3), ('예리한 둔기', 5), 75000),
        (('일격필살', 5), ('예리한 둔기', 3), 1000000),
        (('일격필살', 3), ('예리한 둔기', 4), 75000),
        (('일격필살', 4), ('예리한 둔기', 3), 1000000),
        (('일격필살', 3), ('예리한 둔기', 3), 15000),
        (('일격필살', 3), ('기습의 대가', 5), 1000000),
        (('일격필살', 5), ('기습의 대가', 3), 1000000),
        (('일격필살', 3), ('기습의 대가', 4), 50000),
        (('일격필살', 4), ('기습의 대가', 3), 25000),
        (('일격필살', 3), ('기습의 대가', 3), 25000),
        (('일격필살', 3), ('정기 흡수', 5), 1000000),
        (('일격필살', 5), ('정기 흡수', 3), 12000),
        (('일격필살', 3), ('정기 흡수', 4), 1000000),
        (('일격필살', 4), ('정기 흡수', 3), 12000),
        (('일격필살', 3), ('정기 흡수', 3), 12000),
        (('원한', 3), ('예리한 둔기', 5), 30000),
        (('원한', 5), ('예리한 둔기', 3), 15570),
        (('원한', 3), ('예리한 둔기', 4), 5250),
        (('원한', 4), ('예리한 둔기', 3), 8000),
        ...
        (('원한', 4), ('정기 흡수', 3), 1050),
        (('원한', 3), ('정기 흡수', 3), 500),
        (('예리한 둔기', 3), ('기습의 대가', 5), 5000),
        (('예리한 둔기', 5), ('기습의 대가', 3), 5000),
        (('예리한 둔기', 3), ('기습의 대가', 4), 350),
        (('예리한 둔기', 4), ('기습의 대가', 3), 300),
        (('예리한 둔기', 3), ('기습의 대가', 3), 1),
        (('예리한 둔기', 3), ('정기 흡수', 5), 3000),
        (('예리한 둔기', 5), ('정기 흡수', 3), 2000),
        (('예리한 둔기', 3), ('정기 흡수', 4), 1),
        (('예리한 둔기', 4), ('정기 흡수', 3), 75),
        (('예리한 둔기', 3), ('정기 흡수', 3), 1),
        (('기습의 대가', 3), ('정기 흡수', 5), 1000),
        (('기습의 대가', 5), ('정기 흡수', 3), 2000),
        (('기습의 대가', 3), ('정기 흡수', 4), 1),
        (('기습의 대가', 4), ('정기 흡수', 3), 10),
        (('기습의 대가', 3), ('정기 흡수', 3), 1)
...
if __name__ == "__main__":
    ...
    find_min_set([], [], [], [], [], {'일격필살': 15, '원한': 15, '예리한 둔기': 15, '기습의 대가': 15, '정기 흡수': 15}, {'예리한 둔기': 7, '기습의 대가': 6}, find_price({'일격필살': 15, '원한': 15, '예리한 둔기': 15, '기습의 대가': 15, '정기 흡수': 15}, ['원한', '일격필살']))
